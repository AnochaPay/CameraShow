...
namespace camera_show {
    public partial class Form1 : Form {
        ...
        public SetCamera setCamera = new SetCamera();
        ...
        private void ReadConfigCamera() {
            ...
            try {
                ...
                setCamera.capture.SetCaptureProperty(CapProp.FrameHeight, Convert.ToInt32(Frame_height.Text));
                setCamera.capture.SetCaptureProperty(CapProp.FrameWidth, Convert.ToInt32(Frame_width.Text));
                setCamera.capture.SetCaptureProperty(CapProp.Zoom, zoomSup);
                setCamera.capture.SetCaptureProperty(CapProp.Pan, panSup);
                setCamera.capture.SetCaptureProperty(CapProp.Tilt, tiltSup);
                setCamera.capture.SetCaptureProperty(CapProp.Contrast, contrastSup);
                setCamera.capture.SetCaptureProperty(CapProp.Brightness, brightnessSup);
                setCamera.capture.SetCaptureProperty(CapProp.Focus, focusSup);
                setCamera.capture.SetCaptureProperty(CapProp.Exposure, exposureSup);
                setCamera.capture.SetCaptureProperty(CapProp.Saturation, saturationSup);
                setCamera.capture.SetCaptureProperty(CapProp.Sharpness, sharpnessSup);
                setCamera.capture.SetCaptureProperty(CapProp.Gain, gainSup);
                //setCamera.capture.SetCaptureProperty(CapProp.Gamma, gammaSup);
        ...
        private void ctms_propertySetting_Click(object sender, EventArgs e) {
            ...
            setCamera.capture.SetCaptureProperty(CapProp.Settings, 0);
        }
        ...
        public class SetCamera {
            ...
            public void Show(Form1 main) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Zoom, zoomHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Pan, panHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Tilt, tiltHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Contrast, contrastHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Brightness, brightnessHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Focus, focusHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Exposure, exposureHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                #endregion
                #region ================================ Saturation ================================
                saturationLabel.Text = HeadConfig.saturation;
                ...
                valueScroll = main.setupPay.read_text(headSup + HeadConfig.saturation, main.setPath.stepCsv);
                try {
                    saturationHScroll.Value = Convert.ToInt32(valueScroll);
                    if (!capture.SetCaptureProperty(CapProp.Saturation, saturationHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                try {
                    ...
                    if (!capture.SetCaptureProperty(CapProp.Sharpness, sharpnessHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
                ...
                #endregion
                #region ================================ Gain ================================
                gainLabel.Text = HeadConfig.gain;
                ...
                valueScroll = main.setupPay.read_text(headSup + HeadConfig.gain, main.setPath.stepCsv);
                try {
                    gainHScroll.Value = Convert.ToInt32(valueScroll);
                    if (!capture.SetCaptureProperty(CapProp.Gain, gainHScroll.Value)) {
                        trySup = true;
                    }
                } catch { trySup = true; }
                if (trySup) {
            ...
            public void ZoomScroll(object sender, ScrollEventArgs e) {
                zoomValue.Text = zoomHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Zoom, zoomHScroll.Value);
            }
            public void PanScroll(object sender, ScrollEventArgs e) {
                panValue.Text = panHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Pan, panHScroll.Value);
            }
            public void TiltScroll(object sender, ScrollEventArgs e) {
                tiltValue.Text = tiltHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Tilt, tiltHScroll.Value);
            }
            public void ContrastScroll(object sender, ScrollEventArgs e) {
                contrastValue.Text = contrastHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Contrast, contrastHScroll.Value);
            }
            public void BrightnessScroll(object sender, ScrollEventArgs e) {
                brightnessValue.Text = brightnessHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Brightness, brightnessHScroll.Value);
            }
            public void FocusScroll(object sender, ScrollEventArgs e) {
                focusValue.Text = focusHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Focus, focusHScroll.Value);
            }
            public void FocusClick(object sender, EventArgs e) {
                capture.SetCaptureProperty(CapProp.Autofocus, 1);
                try {
                    focusHScroll.Value = (int)capture.GetCaptureProperty(CapProp.Focus);
                } catch { }
                focusValue.Text = focusHScroll.Value.ToString();
            ...
            public void ExposureScroll(object sender, ScrollEventArgs e) {
                exposureValue.Text = exposureHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Exposure, exposureHScroll.Value);
            }
            public void SaturationScroll(object sender, ScrollEventArgs e) {
                saturationValue.Text = saturationHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Saturation, saturationHScroll.Value);
            }
            public void SharpnessScroll(object sender, ScrollEventArgs e) {
                sharpnessValue.Text = sharpnessHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Sharpness, sharpnessHScroll.Value);
            }
            public void GainScroll(object sender, ScrollEventArgs e) {
                gainValue.Text = gainHScroll.Value.ToString();
                capture.SetCaptureProperty(CapProp.Gain, gainHScroll.Value);
            }
            public void GammaScroll(object sender, ScrollEventArgs e) {
                //gammaValue.Text = gammaHScroll.Value.ToString();
                //capture.SetCaptureProperty(CapProp.Gamma, gammaHScroll.Value);
            }
        ...
        public class CreateMinMax {
            public void Run(Form1 form) {
                ...
                for (int loop = 0; loop < emguCvEnum.Length; loop++) {
                    ...
                    form.setCamera.capture.SetCaptureProperty(emguCvEnum[loop], valueBegin);
                }
            ...
            private string GetType(int loop) {
                ...
                switch (loop) {
                    ...
                    case 6: type = MinMax.saturation; break;
                    case 7: type = MinMax.sharpness; break;
                    case 8: type = MinMax.gain; break;
                }
            ...
            private int GetMin(Form1 form, int valueBegin, int valueRun, CapProp capProp) {
                ...
                while (true) {
                    ...
                    form.setCamera.capture.SetCaptureProperty(capProp, valueStack - valueRun);
            ...
            private void GetFocus(Form1 form) {
                ...
                int loop = 0;
                while (true) {
                    bool result = form.setCamera.capture.SetCaptureProperty(CapProp.Focus, valueBegin + (loop * 5));
                ...
                form.setCamera.capture.SetCaptureProperty(CapProp.Focus, valueBegin);
            }
        }
                ...
                switch (stepNumber) {
                    ...
                    case 2:
                        if (!form.flag.autoFocus) {
                            form.setCamera.capture.SetCaptureProperty(CapProp.Focus, focus);
                            stepNumber++;
                            break;
                        }
                    ...
                    case 4:
                        ...
                        form.setCamera.capture.SetCaptureProperty(CapProp.Contrast, contrast);
                        break;
                    case 5:
                        contrast += scaleNext;
                    ...
                    case 6:
                        ...
                        form.setCamera.capture.SetCaptureProperty(CapProp.Brightness, brightness);
                        break;
                    case 7:
                        brightness += scaleNext;
                    ...
                    case 8:
                        ...
                        form.setCamera.capture.SetCaptureProperty(CapProp.Sharpness, sharpness);
                        break;
                    case 9:
                        sharpness += scaleNext;
        ...
        public class ReAdjust {
            ...
            public void Run(Form1 form) {
                ...
                if (form.flag.autoFocus) {
                    form.setCamera.capture.SetCaptureProperty(CapProp.Focus, focusMiddle);
                    form.setCamera.capture.SetCaptureProperty(CapProp.Focus, focus);
                }

                //เอาค่ากลางมาปรับก่อนแล้วมันน่าจะบัคอยู่
                //form.setCamera.capture.SetCaptureProperty(CapProp.Contrast, contrastMiddle);
                form.setCamera.capture.SetCaptureProperty(CapProp.Contrast, contrast);
                //form.setCamera.capture.SetCaptureProperty(CapProp.Brightness, brightnessMiddle);
                form.setCamera.capture.SetCaptureProperty(CapProp.Brightness, brightness);
                //form.setCamera.capture.SetCaptureProperty(CapProp.Sharpness, sharpnessMiddle);
                form.setCamera.capture.SetCaptureProperty(CapProp.Sharpness, sharpness);
                //form.setCamera.capture.SetCaptureProperty(CapProp.Exposure, exposureMiddle);
                form.setCamera.capture.SetCaptureProperty(CapProp.Exposure, exposure);
            }
        }
        ...
        public static class Cmd {
            ...
            public static readonly string comPear = "compear_image";
